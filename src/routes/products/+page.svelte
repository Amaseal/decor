		...
		<div class="flex gap align">
			<div class="images">
				{#key data.category}
					<div class="image">
						<img
							src="{data.category.description_images.image_1.image_1_source}?height=500"
							alt={data.category.description_images.image_1.image_1_alt}
						/>
					</div>
					<div class="image">
						<img
							src="{data.category.description_images.image_2.image_2_source}?height=300"
							alt={data.category.description_images.image_2.image_2_alt}
						/>
					</div>
					<div class="image">
						<img
							src="{data.category.description_images.image_3.image_3_source}?height=300"
								...
								{#if typeOpen}
									<div transition:slide|local class="tags flex collumn left">
										{#each data.tags as tag}
											<button
												on:click={() => filterByTag(tag.title)}
												on:click={() => (filterOpen = false)}
												class="option">{tag.title}</button
											>
										{/each}
										<button
